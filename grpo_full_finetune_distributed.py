...
class FullGRPOFinetuneRecipeDistributed(FTRecipeInterface):
    ...
    def __init__(self, cfg: DictConfig) -> None:
        ...
        # reward_fn = cfg.get('reward_fn', None)
    ...
    def generate_trajectory(
        ...
        # step 3. estimate logprobs of the responses using the reference policy
        ...
        # step 5. mask out all the invalid values in the trajectory due to padding tokens
